...
- **Primary Summary Metric**: Mean of Macro-F1 across 5 video-isolated validation groups (VG1–VG5).
- **Dispersion**: Sample standard deviation across the 5 held-out folds ($N - 1 = 4$ degrees of freedom).
- **Final Decision**: $E_{J\_FIXED50}$ is the locked authoritative final system (Macro-F1: 0.693905).
