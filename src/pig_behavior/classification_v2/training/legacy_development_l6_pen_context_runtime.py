"""Crash-bounded runtime adapter for legacy pen-context controls."""
...
RUN_RESULT_SCHEMA = (
    "classification_v2.legacy_development_l6.pen_context_run_result.v1"
)
RUN_MANIFEST_SCHEMA = (
    "classification_v2.legacy_development_l6.pen_context_run_manifest.v1"
)
ARTIFACT_MANIFEST_SCHEMA = (
    "classification_v2.legacy_development_l6.pen_context_artifacts.v1"
)
REPEAT_GATE_SCHEMA = (
    "classification_v2.legacy_development_l6.pen_context_repeat_gate.v1"
)
MATRIX_GATE_SCHEMA = (
    "classification_v2.legacy_development_l6.pen_context_short_matrix.v1"
)
RUN_AUDIT_SCHEMA = (
    "classification_v2.legacy_development_l6.pen_context_run_audit.v1"
)
FAILURE_SCHEMA = (
    "classification_v2.legacy_development_l6.pen_context_failure.v1"
)
CHECKPOINT_SCHEMA = (
    "classification_v2.legacy_development_l6.pen_context_checkpoint.v1"
)
CHECKPOINT_MANIFEST_SCHEMA = (
    "classification_v2.legacy_development_l6."
    "pen_context_checkpoint_manifest.v1"
)
PREDICTION_MANIFEST_SCHEMA = (
    "classification_v2.legacy_development_l6."
    "pen_context_prediction_manifest.v1"
)
ENVIRONMENT_SCHEMA = (
    "classification_v2.legacy_development_l6.pen_context_environment.v1"
)

PASS_TRAINING_STATUS = (
    "PASS_LEGACY_DEVELOPMENT_L6_PEN_CONTEXT_TRAINING"
)
PASS_REPEAT_STATUS = "PASS_LEGACY_DEVELOPMENT_L6_PEN_CONTEXT_REPEAT"
PASS_MATRIX_STATUS = "PASS_LEGACY_DEVELOPMENT_L6_PEN_CONTEXT_SHORT_MATRIX"

PEN_CONTEXT_RUNTIME_SPEC = CachedModalityRuntimeSpec(
    ...
    preflight=preflight_pen_context_mode,
    load_inputs=load_pen_context_training_inputs,
    fit_normalization=fit_pen_context_normalization,
    feature_whitelist=pen_context_feature_whitelist,
    train_core=train_pen_context_core,
    git_guard=pen_context_training_git_guard,
    implementation_hashes=pen_context_implementation_hashes,
)


def run_pen_context_mode(
...
def write_pen_context_repeat_gate(
    config: LegacyL6PenContextConfig,
    *,
    mode: str,
...
def audit_pen_context_repeat_gate(
    config: LegacyL6PenContextConfig,
    *,
    mode: str,
    primary_result_path: Path,
...
def write_pen_context_short_matrix(
    config: LegacyL6PenContextConfig,
    *,
...
def audit_pen_context_short_matrix(
    config: LegacyL6PenContextConfig,
    *,
    repeat_gate_paths: dict[str, Path],
) -> dict[str, Any]:
...
__all__ = [
    ...
    "PEN_CONTEXT_RUNTIME_SPEC",
    "REPEAT_GATE_SCHEMA",
    "audit_pen_context_repeat_gate",
    "audit_pen_context_run",
    "audit_pen_context_short_matrix",
    "run_pen_context_mode",
    "write_pen_context_repeat_gate",
    "write_pen_context_short_matrix",
]
