...
- outputs/classification_v2/review_policy/interaction_review_unit_gui_pilot/behavior_unit_review_decisions.csv
...
- A later apply step should apply unit decisions to temporal_label_intervals/enhanced frame labels and then rebuild sequence windows 6/8/12/16.
