"""Write repeat or complete short-matrix L6 numeric-social gates."""
...
from pig_behavior.classification_v2.training.legacy_development_l6_social_relation_runtime import (
    write_social_relation_repeat_gate,
    write_social_relation_short_matrix,
)
...
def main() -> int:
    ...
    if args.command == "repeat":
        payload = write_social_relation_repeat_gate(
            config,
            mode=args.mode,
        ...
        payload = write_social_relation_short_matrix(
            config,
