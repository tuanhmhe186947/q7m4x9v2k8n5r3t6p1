"""Write deterministic repeat or complete short-matrix L6 ROI gates."""
...
from pig_behavior.classification_v2.training.legacy_development_l6_roi_relation_runtime import (
    write_roi_relation_repeat_gate,
    write_roi_relation_short_matrix,
)
...
def main() -> int:
    ...
    if args.command == "repeat":
        payload = write_roi_relation_repeat_gate(
            config,
            mode=args.mode,
        ...
        payload = write_roi_relation_short_matrix(
            config,
