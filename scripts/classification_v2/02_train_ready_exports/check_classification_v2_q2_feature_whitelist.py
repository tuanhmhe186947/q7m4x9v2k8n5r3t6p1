...
def check_whitelist(
    *,
    ...
    spatial_whitelist = [str(name) for name in trainer_v2.get("spatial_sequence_feature_whitelist", [])]
    ...
    return {
        ...
        "external_generalization_claim": whitelist.get("claim_boundary", {}).get("external_generalization_claim"),
