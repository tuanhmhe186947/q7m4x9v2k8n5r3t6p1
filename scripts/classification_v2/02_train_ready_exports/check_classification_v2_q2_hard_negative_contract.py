...
def check_contract(contract_json: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "requires_oof_native_predictions": contract.get("execution_policy", {}).get("requires_oof_native_predictions"),
        "outer_test_used_for_threshold_tuning": contract.get("execution_policy", {}).get(
            "outer_test_used_for_threshold_tuning"
        ),
        "automatic_label_change_allowed": contract.get("execution_policy", {}).get("automatic_label_change_allowed"),
