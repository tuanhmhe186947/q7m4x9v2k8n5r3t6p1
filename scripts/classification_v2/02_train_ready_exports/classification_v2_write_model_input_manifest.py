...
def main() -> None:
    ...
    manifest = {
        ...
        "artifacts": {
            ...
            "spatial_tcn_forward_smoke_script": (
                "scripts/classification_v2/04_baselines_smokes/check_classification_v2_spatial_tcn_forward.py"
            ),
            ...
            "multimodal_forward_smoke_script": (
            ...
            "native_temporal_predictions": str(
                classification_root / "model_smoke" / "native_temporal_predictions" / "native_temporal_predictions.csv"
            ),
        ...
        "training_contract": {
            ...
            "mask": (
                "Use train_mask.csv/window_valid_for_main_train to exclude invalid/incomplete/review-excluded windows."
            ),
