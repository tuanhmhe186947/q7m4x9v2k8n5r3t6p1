...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Check classification_v2 Q2 progress report evidence.")
    parser.add_argument(
        "--report-json",
        type=Path,
    ...
    parser.add_argument(
        "--output-json",
        type=Path,
        default=Path("outputs/classification_v2/model_design/q2_progress_report_audit.json"),
    )
...
def check_q2_progress_report(*, report_json: Path, report_md: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "launch_markdown_overlong_command_line_count": launch.get("markdown_overlong_command_line_count"),
        "postrun_markdown_runbook_valid": postrun.get("markdown_runbook_valid"),
        "postrun_markdown_overlong_command_line_count": postrun.get("markdown_overlong_command_line_count"),
    }
