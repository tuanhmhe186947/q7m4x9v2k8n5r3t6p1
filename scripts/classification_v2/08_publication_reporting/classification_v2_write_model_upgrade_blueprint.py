...
def main() -> None:
    ...
    blueprint = {
        ...
        "publication_claim_boundary": {
            ...
            "identity_scope": (
                "pig_id is an annotation/track ID within a video/session, not biological identity across videos."
            ),
            "primary_prediction_unit": (
                "native temporal unit / review unit; overlapping windows are training augmentation."
            ),
        },
        ...
        "data_contract": {
            ...
            "validation": {
                ...
                "rule": (
                    "No random frame/window split; report native temporal-unit metrics for confirmatory evaluation."
                ),
            },
        },
        "module_script_design": {
            "image_context_index": {
                ...
                "builder": (
                    "scripts/classification_v2/03_image_cache_context/classification_v2_build_image_context_index.py"
                ),
                "checker": (
                    "scripts/classification_v2/03_image_cache_context/check_classification_v2_image_context_index.py"
                ),
            ...
            "image_sequence_tensor_loader": {
                ...
                "checker": (
                    "scripts/classification_v2/03_image_cache_context/check_classification_v2_image_tensor_loader.py"
                ),
            ...
            "spatial_tcn_smoke_trainer": {
                ...
                "runner": "scripts/classification_v2/04_baselines_smokes/classification_v2_spatial_tcn_smoke_train.py",
                "checker": (
                    "scripts/classification_v2/04_baselines_smokes/check_classification_v2_spatial_tcn_smoke_train.py"
                ),
            ...
            "multimodal_forward_smoke": {
                ...
                "checker": (
                    "scripts/classification_v2/04_baselines_smokes/check_classification_v2_multimodal_forward.py"
                ),
                "purpose": (
            ...
            "multimodal_smoke_trainer": {
                ...
                "runner": "scripts/classification_v2/04_baselines_smokes/classification_v2_multimodal_smoke_train.py",
                "checker": (
                    "scripts/classification_v2/04_baselines_smokes/check_classification_v2_multimodal_smoke_train.py"
                ),
            ...
            "interaction_context_index": {
                ...
                "builder": (
                    ...
                    "classification_v2_build_interaction_context_index.py"
                ),
                "checker": (
                    "scripts/classification_v2/03_image_cache_context/"
                    "check_classification_v2_interaction_context_index.py"
                ),
                "purpose": "Audit full-frame and partner-context readiness for fight/social-nose windows.",
            },
            "auxiliary_targets": {
                "builder": (
                    "scripts/classification_v2/02_train_ready_exports/classification_v2_build_auxiliary_targets.py"
                ),
                "checker": (
                    "scripts/classification_v2/02_train_ready_exports/check_classification_v2_auxiliary_targets.py"
                ),
            ...
            "experiment_registry": {
                ...
                "runner": "scripts/classification_v2/08_publication_reporting/classification_v2_register_experiment.py",
                "checker": (
                    "scripts/classification_v2/08_publication_reporting/check_classification_v2_experiment_registry.py"
                ),
                "purpose": (
            ...
            "shortcut_controls": {
                "checker": (
                    ...
                    "check_classification_v2_spatial_control_shortcuts.py"
                ),
            ...
            "native_temporal_prediction_collapse": {
                ...
                "runner": (
                    ...
                    "classification_v2_collapse_window_predictions_to_native_units.py"
                ),
                "checker": (
                    "scripts/classification_v2/07_postrun_evaluation/"
                    "check_classification_v2_native_temporal_predictions.py"
                ),
                "purpose": (
                    "Collapse overlapping window predictions to native temporal/review units for claim-safe metrics."
                ),
            },
        },
        ...
        "known_risks": [
            ...
            },
            {
                ...
                "required_control": (
                    "Use event-balanced weights for training and native temporal-unit evaluation for claims."
                ),
            },
            {
                "risk": "interaction labels need full-frame/partner context",
                "required_control": (
                    "Use CVAT video full-frame rendering and partner overlays for interaction review/training audits."
                ),
            },
        ],
        "next_recommended_commands": [
            "python scripts/classification_v2/03_image_cache_context/classification_v2_build_image_context_index.py",
            "python scripts/classification_v2/03_image_cache_context/check_classification_v2_image_context_index.py",
            "python scripts/classification_v2/04_baselines_smokes/"
            "classification_v2_spatial_tcn_smoke_train.py --steps 8 "
            "--per-class-train 4 --per-class-eval 2 --hidden-dim 64",
            "python scripts/classification_v2/04_baselines_smokes/check_classification_v2_spatial_tcn_smoke_train.py",
            ...
            "classification_v2_register_experiment.py --name spatial_tcn_smoke_train "
            "--metrics-json outputs/classification_v2/model_smoke/"
            "spatial_tcn_smoke_train/spatial_tcn_smoke_train_audit.json "
            "--artifact outputs/classification_v2/model_smoke/"
            "spatial_tcn_smoke_train/spatial_tcn_smoke_train_audit.json "
            "--artifact outputs/classification_v2/model_smoke/"
            "spatial_tcn_smoke_train/spatial_tcn_smoke_predictions.csv "
            "--artifact outputs/classification_v2/model_smoke/"
            "spatial_tcn_smoke_train/spatial_tcn_smoke_train.pt "
            "--artifact outputs/classification_v2/train_ready_windows/"
            "model_input_contract.json "
            "--notes split_safe_smoke_subset_not_full_training",
            "python scripts/classification_v2/08_publication_reporting/check_classification_v2_paper_grade_protocol.py",
            "python scripts/classification_v2/08_publication_reporting/"
            "check_classification_v2_experiment_registry.py --record-json "
            "outputs/classification_v2/experiment_registry/"
            "paper_grade_protocol_gate_record.json",
        ],
        "paper_gate_status": {
...
def _training_phases(
    ...
    return [
        ...
        },
        {
            ...
            "policy": (
                "Select uncertain/focus-pair mistakes into review_unit shortlist; never overwrite labels automatically."
            ),
        },
    ]
