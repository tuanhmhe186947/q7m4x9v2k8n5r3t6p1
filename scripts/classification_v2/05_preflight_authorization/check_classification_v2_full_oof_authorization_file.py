...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Check classification_v2 full OOF authorization JSON.")
    parser.add_argument(
        "--preflight-json",
        type=Path,
...
def _audit(
    *,
    ...
    return {
        ...
        "acknowledges_no_q2_claim": authorization.get("acknowledges_no_q2_claim_until_verified"),
        ...
        "binds_preflight_config_sha256": (
            authorization.get("preflight_config_sha256") == preflight.get("config_sha256")
        ),
        "binds_git_commit": authorization.get("git_commit") == preflight.get("git_commit"),
...
def _binding_errors(
    ...
    if authorization.get("preflight_config_sha256") != preflight.get("config_sha256"):
