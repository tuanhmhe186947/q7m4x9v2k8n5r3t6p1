...
def build_launch_packet(
    *,
    ...
    return {
        ...
        "authorization_template_authorized": authorization_template.get(
            "authorized"
        ),
        ...
        "runtime_benchmark": {
            ...
            "throughput_rows_per_sec": runtime_config.get(
                "throughput_rows_per_sec"
            ),
            "peak_reserved_memory_mb": runtime_config.get(
                "peak_reserved_memory_mb"
            ),
            "max_reserved_memory_mb": runtime_benchmark.get(
        ...
        "cache_paths": {
            ...
            "visual_context_manifest_csv": config.get(
                "visual_context_cache_manifest_csv"
            ),
            "visual_context_packed_npy": config.get(
                "visual_context_packed_cache_npy"
            ),
            "visual_context_packed_index_csv": config.get(
...
def _launch_packet_errors(
    *,
    ...
    if authorization_template.get("preflight_config_sha256") != preflight.get(
        "config_sha256"
    ):
