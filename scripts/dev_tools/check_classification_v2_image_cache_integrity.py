...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "outputs/classification_v2/image_cache_v2_letterbox/image_cache_integrity_manifest.csv"
        ),
    )
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "outputs/classification_v2/image_cache_v2_letterbox/check_image_cache_integrity_audit.json"
        ),
    )
