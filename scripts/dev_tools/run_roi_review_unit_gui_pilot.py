...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run ROI-intent review-unit GUI pilot.")
    parser.add_argument(
        "--review-units-csv",
        type=Path,
        default=Path(r"outputs/classification_v2/review_units/roi_review_unit_template.csv"),
    )
    parser.add_argument(
        "--frame-features-csv",
        type=Path,
