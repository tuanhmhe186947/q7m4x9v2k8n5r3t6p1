...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Read existing classification_v2 pre-full artifacts and produce one "
            "non-training readiness verdict."
        )
    )
    parser.add_argument(
        "--model-design-dir",
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "full_oof_readiness_once_audit.json"
        ),
    )
    ...
    return {
        ...
        "preflight": {
            ...
            "estimated_training_minutes_excluding_eval": round(
                float(preflight.get("estimated_training_seconds_excluding_eval") or 0)
                / 60.0,
                2,
            ),
        },
        "q2_progress": {
            ...
            "full_oof_execution_allowed": q2_audit.get(
        ...
        "authorization": {
            ...
            "acknowledges_no_q2_claim_until_verified": authorization.get(
        ...
        "launch_packet": {
            ...
            "authorization_command_ready": launch_audit.get(
                "authorization_command_ready"
            ),
            "markdown_runbook_valid": launch_audit.get("markdown_runbook_valid"),
            "markdown_overlong_command_line_count": launch_audit.get(
        ...
        "postrun_packet": {
            ...
            "completion_gate_precheck_claim_allowed": postrun_audit.get(
                "completion_gate_precheck_claim_allowed"
            ),
            "markdown_runbook_valid": postrun_audit.get("markdown_runbook_valid"),
            "markdown_overlong_command_line_count": postrun_audit.get(
                "markdown_overlong_command_line_count"
            ),
        },
