...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run posture review-unit GUI pilot.")
    parser.add_argument(
        "--review-units-csv",
        type=Path,
        default=Path(r"outputs/classification_v2/review_units/posture_review_unit_template.csv"),
    )
    parser.add_argument(
        "--frame-features-csv",
        type=Path,
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path(r"outputs/classification_v2/review_policy/posture_review_unit_gui_pilot"),
    )
    ...
    cmd = [
        sys.executable,
        r"scripts\behavior_review_tools\review_temporal_unit_gui.py",
        "--review-units-csv", str(args.review_units_csv),
        "--frame-features-csv", str(args.frame_features_csv),
        "--output-dir", str(args.output_dir),
        "--video-root", str(args.video_root),
