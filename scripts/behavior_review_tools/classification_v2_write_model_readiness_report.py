...
def _render_markdown(summary: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Multimodal forward logits: {forward.get('logit_shape')}; mask delta: {forward.get('max_masked_padding_delta')}",
        ...
        f"- Interaction windows: {interaction.get('interaction_window_rows')}; ready: {interaction.get('interaction_ready_rows')}",
